...
## Regulatory Correspondence & Legal Opinions

| Document | Description |
|---|---|
| [Written Resolutions of Directors — Amendment to Target Markets and Clients (May 2024)]({{ '/docs/2024-05-02-wrd-amendment-target-markets-clients.pdf' | relative_url }}){:target="_blank" rel="noopener noreferrer"} | Board resolution of Kohle Capital Markets Limited passed in lieu of a directors' meeting, formally amending Section 2.6 of the Company's Business Plan to expand the target markets to a global client base across approximately 150 jurisdictions |
| [Legal Opinion — Hong Kong SFO Licensing (March 2024)]({{ '/docs/2024-03-05-legal-opinion-letter-to-kcm.pdf' | relative_url }}){:target="_blank" rel="noopener noreferrer"} | Legal opinion issued by So, Lung & Associates (Solicitors, Hong Kong) on 5 March 2024 (Ref. LP-26185) concluding that, in the absence of active marketing, Kohle Capital Markets Limited is not required to be licensed in Hong Kong under Section 115 of the Securities and Futures Ordinance, Cap. 571 |
| [Legal Opinion — Global Business Licence Scope and Client Onboarding (April 2024)]({{ '/docs/2024-04-25-legal-opinion-kcml.pdf' | relative_url }}){:target="_blank" rel="noopener noreferrer"} | Legal opinion issued by GlobaLex Chambers (Mauritius) on 25 April 2024 confirming the scope of the Global Business regime, the Company's FSC authorisations, and that the Company may onboard clients from any jurisdiction subject to enhanced due diligence obligations and applicable local regulatory requirements |
| [Legal Opinion — Thailand: No CFD Licence Required (March 2026, English)]({{ '/docs/legal-opinion-supplementary.pdf' | relative_url }}){:target="_blank" rel="noopener noreferrer"} | Legal opinion issued by Siamrungroj Law Office Co., Ltd. (Thailand) on 2 March 2026 confirming that under current Thai law there is no specific legislation requiring a licence for the provision of CFD trading services, and that permitting clients to download the KCM Trade application via the App Store does not require a Thai CFD licence |
| [Legal Opinion — Thailand: No CFD Licence Required (March 2026, Thai)]({{ '/docs/legal-opinion-thai.pdf' | relative_url }}){:target="_blank" rel="noopener noreferrer"} | Thai-language version of the legal opinion issued by Siamrungroj Law Office Co., Ltd. on 2 March 2026 (หนังสือเสนอความเห็นทางกฎหมาย — สยามรุ่งโรจน์ ลอว์ ออฟฟิศ) |
...
| Document | Description |
|---|---|
| [Financial Services Commission — Guide to Global Business]({{ '/docs/fsa-guide-to-global-business.pdf' | relative_url }}){:target="_blank" rel="noopener noreferrer"} | Financial Services Commission, Mauritius — official Guide to Global Business, issued 25 January 2012 under Section 7(1)(a) of the Financial Services Act 2007 |
